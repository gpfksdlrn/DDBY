            ...
            <div class="row">
                <div class="col-lg-12">
                        	...
                        	<c:forEach var="m" items="${movie}" varStatus="status">
	                            ...
	                            <input type="hidden" value="${m.movie_tem}" class="youtube_tem">
	                                ...
	                                <c:if test="${status.count < 4}">
	                                	<div class="rank_categories"><img width="70px" height="70px" src="resources/img/Rank${status.count}.png"></div>
	                                </c:if>
					...
					<c:if test="${ pi.currentPage ne 1 }">
						<c:url var="before" value="moviechart.do">
					...
					<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
						...
						<c:if test="${ p ne pi.currentPage }">
							<c:url var="pagination" value="moviechart.do">
					...
					<c:if test="${ pi.currentPage ne pi.maxPage }">
						<c:url var="after" value="moviechart.do">
							<c:param name="currentPage" value="${ pi.currentPage + 1 }"/>
						</c:url> 
