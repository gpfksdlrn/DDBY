            ...
            <form action="seat.do" method="post">
	            <div class="article article_time">
	                ...
	                <div class="inner">
	                    ...
	                    <!-- 상영시간표 -->
	                    <div class="scheduler_wrap" style="overflow-y:auto; ">
	                        <div class="timeScroll">
	                        <!-- 영화타이틀 시작 -->
	                        	<input type="hidden" value="0" id="dayPic">
	                        	<input type="hidden" value="0" id="moviePic">
	                        <!-- 영화타이틀 끝 -->
	                        </div>
	                    </div>
	                </div>
	            </div>
	            <input type="hidden" value="" name="ms_no" id="ms_no">
	            <button type="submit" style="visibility: hidden;" id="sub_btn"></button>
            </form>
        </div>
        <script>
            // 달력 스크립트
