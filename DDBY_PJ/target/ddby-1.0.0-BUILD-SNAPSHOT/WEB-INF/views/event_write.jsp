...
<body>
    ...
    <!-- Anime Section Begin -->
<form action="inputEvent.do" method="post" enctype="multipart/form-data">
   <section class="anime-details spad event_section">
    ...
    <div style="width: 980px; margin: 0 auto">
        <textarea id="summernote_Mail" name="event_content" value="${event.event_content}"></textarea> 
    </div>
    
    <section class="anime-details spad">
        <button type="submit" class="btn_mywish event_input_btn">글 작성</button>
    </section>
</form>
    <!-- Anime Section End -->
